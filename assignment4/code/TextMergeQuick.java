...
// QUICK SORT
	public static <T extends Comparable<? super T>>
		   void quickSort(T[] array, int n, int minSize, boolean randomPivot)
	{
		quickSort(array, 0, n-1, minSize, randomPivot);
	} // end quickSort
	...
	public static <T extends Comparable<? super T>>
	       void quickSort(T[] a, int first, int last, int minSize, boolean randomPivot)
	{
	  ...
	  else
	  {
			...
			if (randomPivot)
			{
				pivotIndex = first + r.nextInt(last - first);
			}
			else
			{
	    ...
	    quickSort(a, first, pivotIndex - 1, minSize, randomPivot);
	    quickSort(a, pivotIndex + 1, last, minSize, randomPivot);
	  } // end if
	} // end quickSort
