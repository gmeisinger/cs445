...
public class Assig3
{
    ...
    public void printPath(Stack<String> path, String phrase)
    {
        ...
        // filters out coordinates in middle of words and prints
        int count = 0;
        int pathIndex = 0;
    ...
    /**
     * Constructor method, reads file and takes user input before making the actual recursive call to findPhrase.
     */
    public Assig3()
    {
