...
public class Assig2A
{
	...
	{
		// Testing constructor
		LinkedDS<Integer> L1 = new LinkedDS<Integer>();
		for (int i = 0; i < 10; i++)
		{
		...
		// work as expected!
		LinkedDS<String> L3 = new LinkedDS<String>();
		LinkedDS<String> L4 = new LinkedDS<String>();
		LinkedDS<String> L5 = new LinkedDS<String>();
